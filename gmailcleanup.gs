function cleanUp(age, searchString) {
  ...
  GmailApp.sendEmail("code9101@gmail.com", searchString + ": Script removed " + amountCleaned.toString() + " Emails", "Your email cleanup script for search" + '"' + searchString + '"' + " sucessfully ran");
}
